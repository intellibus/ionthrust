...
- [ionthrust design](#ionthrust-design)
...
`ionthrust` is designed to make building chrome extensions a seamless process.

## How is it different from what I already use?

**WORK IN PROGRESS**: `ionthrust` is still in the `design` phase.
...
`ionthrust` is a part of the [Open Source Universe](https://github.com/intellibus/approach). All Projects in the [Open Source Universe](https://github.com/intellibus/approach) follow the same [Contribution Guidelines & Process](https://github.com/intellibus/approach).
...
`ionthrust` only plans to initially support Typescript & JavaScript Applications. However, we would love for the community to contribute versions for other languages (Java, Go, etc.)
